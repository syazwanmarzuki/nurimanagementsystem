						...
						<div class="inner">
							...
							<!-- Content -->
								<section>
									...
									<h2 align="center"><p class="large"><font color="black"><b>Taman Nusa Perintis Branch</b></p></h2>
                                        <table border="1px" width="100%" color="black">
                                          ...
                                          <?php
                                            ...
                                            $query = mysql_query("Select * from list WHERE branch='taman nusa perintis'"); // SQL Query
